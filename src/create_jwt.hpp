#ifndef _CREATE_JWT_HPP_
#define _CREATE_JWT_HPP_
...
public:
    JWTCreator(std::string key_name_path = "apikeyname.txt", std::string key_secret_path = "apiprivkey.txt") : m_key_name(read_str_from_file(key_name_path)),
    m_key_secret(read_str_from_file(key_secret_path)){}

std::string create(std::string request_method, std::string request_path, std::string url = "api.coinbase.com") {
